...
const VARIABLE_DEFINITIONS: VariableDefinitionSpec[] = [
  {
    ...
    dataType: 'enum',
    allowedValues: {
      values: ['CPA', 'CAS', 'bookkeeping', 'payroll_bureau', 'fractional_CFO', 'employer', 'other'],
    },
    ...
    helpText: 'Select the best-supported primary category; use unknown status when evidence is absent.',
  },
  {
    key: 'employee_count',
  ...
  },
  {
    ...
    dataType: 'enum',
    allowedValues: {
      values: ['founder_owned', 'partner_owned', 'employee_owned', 'private_equity', 'public', 'nonprofit', 'other', 'unknown'],
    },
  ...
  ...([
    ['payroll_offered', 'Payroll Offered', 'Whether payroll services are offered.', ['service_page', 'direct_entry']],
    ['bookkeeping_offered', 'Bookkeeping Offered', 'Whether bookkeeping services are offered.', ['company_website', 'direct_entry']],
    ['cas_offered', 'CAS Offered', 'Whether client accounting/advisory services are offered.', ['company_website', 'direct_entry']],
    ['fractional_cfo_offered', 'Fractional CFO Offered', 'Whether fractional CFO services are offered.', ['company_website', 'direct_entry']],
    ['hr_advisory_offered', 'HR Advisory Offered', 'Whether HR advisory services are offered.', ['company_website', 'direct_entry']],
    ['benefits_advisory_offered', 'Benefits Advisory Offered', 'Whether benefits advisory services are offered.', ['company_website', 'direct_entry']],
    ['technology_consulting_offered', 'Technology Consulting Offered', 'Whether technology consulting services are offered.', ['company_website', 'direct_entry']],
  ] as const).map(([key, label, description, methods]) => ({
    key,
    label,
    description,
  ...
  })),
  {
    ...
    evidenceRequirements: { required: 'source or direct evidence' },
    applicableWorkflows: ['research', 'discovery', 'qualification'],
    helpText: 'Select the supported delivery model; contradictions should remain contradicted until reviewed.',
  },
  {
  ...
  ...([
    ...
    ['process_standardization', 'Process Standardization', 'Repeatability and documentation maturity.'],
    ...
    ['client_decision_influence', 'Client Decision Influence', 'Ability to shape client vendor choice.'],
    ['trusted_advisor_status', 'Trusted Advisor Status', 'Depth of client reliance.'],
    ['workforce_data_access', 'Workforce Data Access', 'Legitimate access or visibility into workforce data.'],
    ['recommendation_authority', 'Recommendation Authority', 'Advisory authority over payroll or HR selection.'],
    ['executive_access', 'Executive Access', 'Access to decision-makers.'],
    ['provider_satisfaction', 'Provider Satisfaction', 'Satisfaction with current payroll provider.'],
    ['switching_friction', 'Switching Friction', 'Expected difficulty of switching providers.'],
    ['competitive_openness', 'Competitive Openness', 'Openness to evaluating alternative providers.'],
  ...
  ...([
    ...
    applicableWorkflows: ['research', 'discovery', 'qualification'],
    helpText: 'Record the event date when the trigger is present; stale triggers should not remain permanently current.',
  })),
  {
  ...
  },
  {
    ...
    applicableWorkflows: ['discovery', 'qualification'],
    helpText: 'Store the renewal date when known; use not_applicable where there is no relevant contract.',
  },
  {
    ...
    allowedValues: {
      values: ['service_quality', 'pricing', 'integration', 'support', 'compliance', 'reporting', 'other'],
...
async function seedEvidenceRecords(
  ...
  const specs = [
    ...
    },
    {
      ...
      payload: { estimated_revenue: { currency: 'USD', min_minor_units: 250000000, max_minor_units: 400000000 } },
...
async function seedVariableValues(
  ...
  const valuesToInsert: Array<{ key: string; definitionKey: string; values: VariableValueInsert }> = [
    valueSpec('employee-count-known', 'employee_count', '30000000-0000-4000-8000-000000000001', ids, definitionRefs, {
      organizationKey: 'atlas',
      typedValue: { value: 42 },
    ...
    valueSpec('years-zero', 'years_in_business', '30000000-0000-4000-8000-000000000002', ids, definitionRefs, {
      organizationKey: 'brightside',
      typedValue: { value: 0 },
    ...
    valueSpec('payroll-false', 'payroll_offered', '30000000-0000-4000-8000-000000000003', ids, definitionRefs, {
      organizationKey: 'cedar',
    ...
    valueSpec('growth-unknown', 'growth_stage', '30000000-0000-4000-8000-000000000004', ids, definitionRefs, {
      organizationKey: 'cedar',
    ...
    valueSpec('contract-na', 'contract_renewal_date', '30000000-0000-4000-8000-000000000005', ids, definitionRefs, {
      organizationKey: 'cedar',
    ...
    valueSpec('ownership-withheld', 'ownership_type', '30000000-0000-4000-8000-000000000006', ids, definitionRefs, {
      organizationKey: 'brightside',
    ...
    valueSpec('delivery-contradicted', 'payroll_delivery_model', '30000000-0000-4000-8000-000000000007', ids, definitionRefs, {
      organizationKey: 'atlas',
    ...
    valueSpec('staffing-stale', 'staffing_pressure', '30000000-0000-4000-8000-000000000008', ids, definitionRefs, {
      organizationKey: 'cedar',
      typedValue: { value: 3 },
    ...
    valueSpec('client-count-range', 'estimated_client_count', '30000000-0000-4000-8000-000000000009', ids, definitionRefs, {
      organizationKey: 'atlas',
    ...
    valueSpec('bookkeeping-original', 'bookkeeping_offered', '30000000-0000-4000-8000-000000000010', ids, definitionRefs, {
      organizationKey: 'atlas',
      typedValue: { value: false },
      normalizedValue: { value: false },
      valueStatus: 'known',
    ...
    valueSpec('bookkeeping-override', 'bookkeeping_offered', '30000000-0000-4000-8000-000000000011', ids, definitionRefs, {
      organizationKey: 'atlas',
    ...
    valueSpec('payroll-multi-evidence', 'payroll_offered', '30000000-0000-4000-8000-000000000012', ids, definitionRefs, {
      organizationKey: 'atlas',
      typedValue: { value: true },
      normalizedValue: { value: true },
      valueStatus: 'known',
    ...
    valueSpec('revenue-range', 'estimated_revenue', '30000000-0000-4000-8000-000000000013', ids, definitionRefs, {
      organizationKey: 'atlas',
      typedValue: { currency: 'USD', min_minor_units: 250000000, max_minor_units: 400000000 },
      normalizedValue: { currency: 'USD', min_minor_units: 250000000, max_minor_units: 400000000 },
      valueStatus: 'known',
